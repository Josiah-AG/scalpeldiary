        ...
        <div className="flex-1 overflow-y-auto p-6">
          <div className="space-y-4">
            {Object.entries(progress.categories)
              ...
              return (
                <div key={category} className="border-2 border-gray-200 rounded-xl overflow-hidden hover:border-blue-300 transition-colors">
                  {/* Category Header */}
                  <div className="bg-gradient-to-r from-gray-50 to-gray-100 p-5">
                    ...
                    >
                      <div className="flex items-center space-x-3">
                        <div className={`w-6 h-6 rounded-full ${categoryCircleColor} flex-shrink-0`}></div>
                        <span className="font-bold text-xl text-gray-900">{category}</span>
                        <span className="text-sm text-gray-600">
                          ({procedures.filter(p => p.isComplete).length} / {procedures.length} groups complete)
                        </span>
                      </div>
                    ...
                    <div className="w-full">
                      <div className="flex justify-between text-sm mb-2">
                        <span className="text-gray-700 font-medium">Category Progress:</span>
                    ...
                    <div className="p-6 space-y-4 bg-white">
                      {procedures
                        ...
                        <div 
                          ...
                          } pl-5 pr-4 py-4 rounded-r-lg`}
                        >
                          <div className="flex justify-between items-start mb-3">
                            <div className="flex items-center space-x-3 flex-1">
                              <div className={`w-4 h-4 rounded-full ${circleColor} flex-shrink-0`}></div>
