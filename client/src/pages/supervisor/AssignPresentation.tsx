...
import { FileText, Plus, Calendar, User, UserCheck } from 'lucide-react';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (editingAssignment) {
        ...
        await api.post('/presentation-assignments', formData);
      }
      ...
      alert(error.response?.data?.error || 'Failed to assign presentation');
    }
  };
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setFormData({ ...formData, moderator_id: e.target.value })}
                  className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-amber-500"
                  required
                >
