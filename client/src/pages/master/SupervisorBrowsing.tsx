...
import { User, Star, FileText, Presentation, Building2, Stethoscope } from 'lucide-react';
            ...
            {supervisors.map((supervisor) => (
              ...
              >
                ...
                <div className="space-y-3 border-t pt-4">
                  ...
                  {supervisor.total_procedures_rated > 0 && (
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-2">
                      ...
                      <span className="font-semibold text-blue-600">
                        {Number(supervisor.avg_procedure_rating).toFixed(1)}
                      </span>
                    </div>
                  )}
                  ...
                  {supervisor.total_presentations_rated > 0 && (
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-2">
                      ...
                      <span className="font-semibold text-green-600">
                        {Number(supervisor.avg_presentation_rating).toFixed(1)}
                      </span>
                    </div>
                  )}
                </div>
